...
public class PlayerStatController : MonoBehaviour
{
    ...
    public void UpdateDisplay()
    {
        ...
        {
            UIController.instance.maxWeaponsUpgradeDispaly.UpdateDisplay(maxWeapons[maxWeaponsLevel+1].cost, maxWeapons[maxWeaponsLevel].value, maxWeapons[maxWeaponsLevel+1].value);
        }else
        {
            UIController.instance.maxWeaponsUpgradeDispaly.ShowMaxLevel();
        }
    }
